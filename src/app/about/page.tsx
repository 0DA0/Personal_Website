...
export const metadata: Metadata = {
  title: 'Hakkımda',
  description:
    'Doğukan hakkında — Full Stack Web Developer. Angular, Node.js, Python ile modern ve ölçeklenebilir web uygulamaları geliştiriyorum.',
};
  ...
  return (
    <>
      <style>{`
        ...
        .about-card h3 {
          color: var(--neon-green); font-size: 1.5rem; margin-bottom: 0.3rem;
        }
        ...
        .bio-section h4 {
          color: var(--neon-green); font-size: 1.1rem; margin-bottom: 1rem;
          padding-bottom: 0.5rem; border-bottom: 1px solid var(--dark-green);
        }
        .bio-text {
        ...
        .social-btn {
          ...
          background: transparent; border-radius: 2px; display: inline-block;
          transition: all 0.3s; font-family: var(--font-mono);
          ...
          <div className="about-grid">
            ...
            <div className="bio-section">
              ...
              <p className="bio-text">
                Full Stack Web Developer olarak Angular, Node.js, Python ve modern web teknolojileriyle
                ölçeklenebilir ve güvenli web uygulamaları geliştiriyorum. Temiz kod yazmak, sistem
                tasarımı ve performans optimizasyonu konularında tutkuyla çalışıyorum.
              </p>
              <p className="bio-text">
                Hem frontend hem backend tarafında güçlü bir deneyime sahibim. RESTful API tasarımından
                veritabanı optimizasyonuna, kullanıcı arayüzü geliştirmeden DevOps pratiklerine kadar
                geniş bir yelpazede proje deneyimim bulunuyor.
              </p>
              ...
              <div className="social-links">
                <a href="https://github.com/0DA0" target="_blank" rel="noopener noreferrer" className="social-btn">
                  GitHub
                </a>
                <a href="https://www.linkedin.com/in/doğukan-aras-424184340/" target="_blank" rel="noopener noreferrer" className="social-btn secondary">
                  LinkedIn
                </a>
              </div>
            </div>
